...
\begin{enumerate}
    \item \textbf{Validação cross-domain:} avaliar desempenho em gêneros textuais específicos (acadêmico, jornalístico, literário) onde LLMs podem comportar-se diferentemente.
    ...
    \item \textbf{Características adicionais:} explorar métricas alternativas de diversidade lexical (MTLD), embeddings contextuais, ou seleção automática de características.
\end{enumerate}
