...
O classificador fuzzy alcança \textbf{ROC AUC de 89,34\%}, demonstrando capacidade substancial de discriminação entre textos autorais e de LLM. Embora este desempenho seja aproximadamente 5 pontos percentuais inferior à LDA e 8 pontos percentuais inferior à regressão logística, o resultado permanece notavelmente alto, especialmente considerando a simplicidade do sistema fuzzy proposto (funções triangulares básicas com agregação por média aritmética).
