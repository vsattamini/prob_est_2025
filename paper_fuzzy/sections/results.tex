...
Entretanto, esta diferença deve ser interpretada no contexto do \textbf{custo de oportunidade}: o classificador fuzzy sacrifica ~8\% de AUC em troca de interpretabilidade completa, robustez superior e eficiência computacional -- um compromisso justificável em aplicações onde explicabilidade é prioritária.
