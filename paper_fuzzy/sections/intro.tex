...
\begin{enumerate}
    \item \textbf{Interpretabilidade}: ao contrário de modelos de caixa-preta (redes neurais, gradient boosting), os graus de pertinência e as regras fuzzy são inspecionáveis, permitindo auditoria e compreensão do processo decisório.
